package hyman.springbootdemo.demo.springRabbit.messageAdapter;
...
public class ConsumerApplicationAuto {

    public static void main(String[] args) {
        new AnnotationConfigApplicationContext(ConsumerApplicationAuto.class);
    }
}
